...
# -*- coding: utf-8 -*-
#
# Mycroft Light documentation build configuration file
#
...
latex_elements = {}
latex_documents = [
    (master_doc, 'MycroftSimple.tex', 'Mycroft Light Documentation',
...
man_pages = [
    (master_doc, 'mycroftsimple', 'Mycroft Light Documentation',
     [author], 1)
]
